...
def calculate_safety_score(lat: float, lng: float, hour: int) -> int:
    score = 100
    ...
    # Instead of counting incidents, we sum their weights.
    # One fresh verified report hits harder than 10 old ones.
    ...
    if incidents:
        ...
        if any(i['verified'] for i in incidents):
