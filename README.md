...
SafeWalk/
│
├── api_server.py                     # Flask REST API Server (Bridges backend to web app)
│
...
│
├── frontend/                         # Pure HTML/CSS/JS Web App Layer
│   ├── index.html                     # Single-Page Web App Structure (Sidebar, Tabs, Leaflet map)
│   ├── styles.css                     # Premium Animated Light Theme (Plus Jakarta Sans, Glassmorphism)
│   └── app.js                         # Application Logic (State, Leaflet routes, API fetch calls)
│
...
### 2️⃣ Running the SafeWalk Web Application

Launch the Flask REST API & Web Server:
...
| **User Interface** | Standard mapping | **Animated Light-Mode Web App (HTML/CSS/JS + Leaflet)** |
...
- **Vidit Raturi** — **Team Lead**  
  *Full-Stack System Integration, HTML/CSS/JS Web App Architecture, Flask REST API, OWASP Security Hardening, Dynamic Decay Weight Engine, High-Precision Multi-Stage Geocoding, and Gemini/RAG Integration.*
- **Vanshika** — **Frontend Lead**  
  *Map Component Architecture, Live Incident Feed Components, UI/UX Layout, and Emergency SOS Interface.*
